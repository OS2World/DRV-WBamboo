...
dataseg
; idProduct<D0><D1><D2><D3><D4><D5><D6><D7><D8><D9><DA><DB><DC><DD><DE><DF>
TypeSize db 10h,30h,30h,31h,20h,21h,30h,30h,31h,00h,30h,31h,00h,20h,30h,31h
...
dataseg
GetFingerInput db 0ECh,00h,0FFh,0FFh,82h,03h,14h,00h,14h dup(0EEh)
...
dataseg
PutStylusEvent tbl {xMax0=14720,yMax0=9200,xMax1=21650,yMax1=13700}
